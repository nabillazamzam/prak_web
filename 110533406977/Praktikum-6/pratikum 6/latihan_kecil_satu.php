...
<head>
        <title>Latihan Kecil satu</title>
</head>
...
<form action="<?php $_SERVER['PHP_SELF'];?>" method="get">
        ...
        ?>>
        <br><br>
        Alamat :<input type="text" name="alamat" size=40 value=<?php
        echo isset($_GET['alamat']) ? $_GET['alamat'] :'';
        ?>>
        <br>
...
$sql = "SELECT * FROM mahasiswa
        WHERE nama LIKE '%$key%' OR alamat LIKE '%$key2%'";
