...
$objPHPExcel->getProperties()->setCreator("Iman Budi Hutomo")
							 ->setLastModifiedBy("Iman Budi Hutomo")
...
$query = mysql_query('select * from mahasiswa, prodi WHERE mahasiswa.kdprodi = prodi.kdprodi');
...
while($data=mysql_fetch_array($query)){
	...
	$objPHPExcel->getActiveSheet()->setCellValue('F'.$i, $data['namaprodi']);
	$i++;
	$no++;
}
